    ...
    class ListeActualite extends Component {
        ...
        render() { 
            return ( <div className="toplist">
                ...
                { tab2.map((el,index)=><div className="col-lg-6 col-md-6 col-sm-12 cactu1" ><FirstActualite item={el} key={index}  /> 
            </div>)}
                
                </div>
                 <div className="row actu2 container-fluid">
            { tab.map((el,index)=><div className="col-lg-4 col-md-6 col-sm-12"><Actualite item={el} key={index}  /> 
            </div>)}
