...
class Details extends Component {
    ...
    render() { 
        return ( <div>
            ...
            <div className="row line4res">
             <div className="col-lg-6 col-md-12 col-sm-12">
             <p className="pdetails"> <i class="fa fa-check"></i> Cable TV</p>
             <p className="pdetails"> <i class="fa fa-check"></i> Kitchen</p>
             <p className="pdetails"> <i class="fa fa-check"></i>Swimming Pool  </p> 
             <p className="pdetails"> <i class="fa fa-check"></i>Air condition</p>
             </div>
             <div className="col-lg-6 col-md-12 col-sm-12">
             <p className="pdetails"> <i class="fa fa-check"></i>Barbeque</p>
             <p className="pdetails"> <i class="fa fa-check"></i>Dryer</p>
             <p className="pdetails"> <i class="fa fa-check"></i>Laundry</p>
             <p className="pdetails"> <i class="fa fa-check"></i>WIFI</p>
             </div>
            </div>
            </div>
